<template>
  <ion-page @ionViewDidEnter="findAllRecords">
    <ion-header :translucent="true">
      <ion-toolbar>
        <ion-title>Base de datos | Usuarios</ion-title>
      </ion-toolbar>
            ...
            <ion-card v-for="(item, index) in items" :key="index" class="card-width">
              <ion-card-content>
                ...
                <ion-item>
                  ...
                  <ion-label>{{ item.contenido }}</ion-label>
                </ion-item>
                <ion-item>
                  <ion-label>Prioridad: </ion-label>
                  <ion-label>{{ item.prioridad }}</ion-label>
                </ion-item>
                <ion-item>
                  <ion-label>Etiqueta: </ion-label>
                  <ion-label>{{ item.etiqueta }}</ion-label>
                </ion-item>
                <ion-item>
...
// Rutas de la API
const baseURL = 'https://x71f6bvf-9000.use2.devtunnels.ms/Tasky/api/Notas/vista';
